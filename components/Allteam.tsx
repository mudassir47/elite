...
export function AllTeam() {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-lightblue-100 to-white">
      <div className="container mx-auto px-4">
        ...
        >
          {teamMembers.map((member, index) => (
            ...
            >
              <Card className="bg-white shadow-custom-light hover:shadow-custom-heavy transition-all duration-300 transform hover:-translate-y-1">
